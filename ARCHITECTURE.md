...
|---|---|---|
| المظهر | `localStorage.theme` | أول زيارة: تفضيل النظام. بعد اختيار يدوي: يُحفظ ويُقدَّم. ما لم يختر المستخدم يدويًا يظل يتابع تغيّر النظام. |
...
`ThemeScript.astro` يعمل **قبل الرسم** لمنع وميض الشاشة.

**فارق مقصود عن الأصل:** كان `menu.js` القديم يُخفي زر الوضع الليلي قسرًا ويفرض تفضيل النظام.
الآن الزر ظاهر ويعمل، مع النظام كقيمة ابتدائية — وهذا ما طلبه المالك صراحة.
